...
public class SceneScreenshotter : MonoBehaviour
{
    ...
    static readonly (string name, Vector3 pos, Vector3 euler)[] shots = new[]
    {
        ...
        ("05_corridor_entry",  new Vector3(-5f, 1.6f, -5f),    new Vector3(0f, 180f, 0f)),
        ("06_grotto_inside_corridor", new Vector3(-5f, 1.6f, -10f), new Vector3(0f, 0f, 0f)),
        ("07_grotto_interior", new Vector3(-5f, 1.6f, -15f),   new Vector3(0f, 0f, 0f)),
        ("08_grotto_streams",  new Vector3(-5f, 1.6f, -20f),   new Vector3(0f, 0f, 0f)),
